...
export default [
  ...
  },
  {
    ...
    content: [
      ...
      "Developed an alpha Android App based on by Kotlin. Developed pose estimation games by JavaScript and P5.js framework. Collected exercises information using crawler by Python.",
      "Being a small Agile team which need to handle urgent and unplanned tasks in a limited of time.",
      "Our products successfully attracted investors. I acquired the abilities of rapid learning and the iterative development mode in a flat management team.",
    ],
    icon: WorkIcon,
    color: "#F3722C",
  },
  {
    ...
    content: [
      "An educational institution had just set up a new branch at Monash, and planed to offer courses in IT, but lacks experienced mentors and company website.",
      "Designed the institute official website. Developed WeChat mini program to support 40+ educational materials. Became one of the popular database tutor.",
  ...
  },
  {
    ...
    content: [
      ...
      "Re-designed and developed the existing website of Disabled Persons' Federation, which utilized Java Spring Framework.",
    ],
    icon: WorkIcon,
    color: "#43AA8B",
  },
